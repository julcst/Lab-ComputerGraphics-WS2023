...
\usepackage{fixmath}                                        % Fix non-ISO behavior with capital Greek letters
%\usepackage{refcheck}                                      % Display warning on unused references
%\ignoreunlbld                                              % Ignore equations in "ref-check"
...
% - Shape -
\usepackage{setspace}                                       % Spacing between lines (MUST BE LOADED BEFORE "hyper-ref")
...
\usepackage{pbox}
% Disable under full box warnings when breaking URLs
\usepackage{etoolbox}
...
% Uncomment the correct type of report. Also, check the language setting at the top of this file.
...
%\title{<Report Title>}
\title{Stable Real-Time Simulation of Mesoscopic Glints}
