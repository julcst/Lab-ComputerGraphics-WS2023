...
\end{equation}
%
Nevertheless, \textcite{deliot2023} decided not to use distributed blending in the surface domain in their implementation, which gives the individual facets a blurrier appearance.
