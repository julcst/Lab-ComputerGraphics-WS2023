...
%
This differs from the original distribution term $D(\vec{\omega_h})$ which only represents the probability of a microfacet being aligned that way. We get
%
\begin{equation}
\begin{aligned}
    D_P(\vec{\omega_h})
...
% TODO: Reference derivation of Zirr and Kaplanyan for p
