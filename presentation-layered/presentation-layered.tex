...
\setbeamertemplate{headline}
 {
   ...
   \begin{beamercolorbox}[wd=\paperwidth,ht=2.25ex,dp=1ex,left]{title in head/foot}%
     \usebeamerfont{title in head/foot} \hspace*{2ex} \insertsection \ifx\insertsubsection\empty\else$\,\blacktriangleright$ \insertsubsection\fi \ifx\insertsubsubsection\empty\else$\,\blacktriangleright$ \insertsubsubsection\fi
   \end{beamercolorbox}%
   }
   \vskip0pt%
 }
...
\begin{frame}
    \titlepage
    \note[item]{Hi and welcome to the presentation of my project group about ...}
    \note[item]{Today I will present you the approach Belcour introduced 2018 and our implementation of it.}
\end{frame}
