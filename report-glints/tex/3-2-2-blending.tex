...
% NOTE: Maybe calculate expectation and variance
% \begin{equation}
%     \begin{aligned}
...
%
We implemented both variants and let the user decide.

One may further notice that we do not correctly blend the likewise randomly distributed meso-facet count $N(P)$ but as this is an intermediate variable we do not observe visible artifacts.
